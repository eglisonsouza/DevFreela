...
namespace Devfreela.Infrastructure.Migrations
{
    ...
    [Migration("20220414141911_LoginAtributes")]
    partial class LoginAtributes
    {
            ...
            modelBuilder.Entity("Devfreela.Core.Entities.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2022, 4, 14, 11, 19, 11, 502, DateTimeKind.Local).AddTicks(5654));
